...
/**
 * Created by nihalpradeep on 16/05/16.
 */
public class AchievementAddTask extends AsyncTask<String,Void,String> {

    String achievement_url = "http://10.0.2.2/Miniproject/achievements.php";
    String title, date, desc;
    Context ctx;

    public AchievementAddTask(Context ctx){
        this.ctx = ctx;
    }
    @Override
